...
<div class="nav container" role="navigation">
    <ul>
        ...
        <g:if test="${session.role == RoleOf.COMMUNITY_SECRETARY}">
            <li>
                <g:link class="create btn bg-success text-white" name="addUser" action="create" controller="user">הוסף
                    משתמש
                </g:link>
            </li>
            <li>
                <g:link class="list btn bg-info text-white" name="showUsers" action="showUsers" controller="user">הצג
                    משתמשים
                </g:link>
            </li>
        </g:if>
