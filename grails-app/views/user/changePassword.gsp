		...
		<div class="row">
			<div class="col-sm-6 col-sm-offset-3">
				...
				<form method="post" id="passwordForm">
					...
					<div class="row">
						<div class="col-sm-6">
							אורך 8 תווים<span id="8char" class="glyphicon glyphicon-remove" style="color:#FF0004;"></span><br>
							 לפחות אות אחת גדולה<span id="ucase" class="glyphicon glyphicon-remove" style="color:#FF0004;"></span>
						</div>
						<div class="col-sm-6">
							 לפחות אות אחת קטנה<span id="lcase" class="glyphicon glyphicon-remove" style="color:#FF0004;"></span><br>
